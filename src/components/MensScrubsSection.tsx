...
const MensScrubsSection = () => {
  const mensScrubs = [
    ...
    {
      id: 3,
      name: 'Men\'s Comfort Fit Green Scrubs',
      price: '₹ 1,699',
      originalPrice: '₹ 2,299',
      rating: 4.6,
    ...
    {
      id: 4,
      name: 'Men\'s Wine Colored Scrubs',
      price: '₹ 1,799',
      originalPrice: '₹ 2,399',
      rating: 4.5,
  ...
  return (
    <section className="py-16 bg-gray-50">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-12 text-purple-800">Men's Scrubs Collection</h2>
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {mensScrubs.map((scrub) => (
...
export default MensScrubsSection;
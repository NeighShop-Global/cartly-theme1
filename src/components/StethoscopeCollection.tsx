...
const StethoscopeCollection = () => {
  const stethoscopes = [
    ...
    },
    {
      ...
      rating: 4.6,
      image: 'https://images.pexels.com/photos/4386467/pexels-photo-4386467.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop',
      colors: ['bg-gray-600', 'bg-black', 'bg-blue-900'],
  ...
  return (
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-12 text-purple-800">Stethoscope Collection</h2>
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {stethoscopes.map((product) => (
...
export default StethoscopeCollection;